...
<?php endif; ?>
<div class="container">
  <?php echo Form::open(['route'=>'showwishlist', 'method'=>'post', 'enctype' => 'multipart/form-data']); ?>
  ...
  <table id="cart" class="table table-hover table-condensed table-responsive product">
    ...
    <tbody>
      ...
      <?php if(session('pwishlist')): ?>
      <?php $__currentLoopData = session('pwishlist'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project(E-Market)\resources\views/wishlist.blade.php ENDPATH**/ ?>