...
<section class="mbr-section content4 cid-qvXDlTpHu4" id="content4-l" data-rv-view="670" style="background-color: #efefef;margin-bottom:10px;">
    <div class="container">
       <div class="media-container-row">
        <h2 class="text-center mbr-fonts-style display-2">
            Laptops/PC</h2>                    
          </div>
       </div>
     </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project(E-Market)\resources\views/Laptop.blade.php ENDPATH**/ ?>